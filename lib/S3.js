...
S3.list = function(bucket, prefix, marker) {
...
S3.write = function(body, targets) {
  return new Promise((success, fail) => {
...
S3.splitObject = function(bucket, key, delimiter, encoding) {
  return new Promise((success, fail) => {
...
S3.put = function(bucket, key, body) {
  if (this.verbose) {
...
S3.copy = function(sourceBucket, sourceKey, targetBucket, targetKey) {
  return new Promise((success, fail) => {
    this.s3.copyObject({
      Bucket: targetBucket,
      Key: targetKey,
...
S3.listObjects = function(bucket, prefix, marker) {
  return new Promise((success, fail) => {
...
S3.deleteObjects = function(bucket, keys) {
  if (this.verbose) {
...
S3.getFileName = key => key.substr(key.lastIndexOf('/') + 1, key.length);
